...
Claude Bridge exposes **158 MCP tools** across **16 categories** that give Claude
...
needs an InfluxDB database set up — a niche feature. **All 158 tools work
...
2. **Restart Claude Code** — you should see 158 `indigo-mcp` tools available
...
The `indigo-mcp` tools will appear on next session start. You should see 158 tools available.
...
**158 tools, grouped by security scope.** This table is **auto-generated** from the
...
<!-- BEGIN TOOL TABLE -->
<!-- AUTO-GENERATED by scripts/generate_tool_doc.py — 158 tools. Do not edit by hand. -->
...
│           └── tools/                      # 19 tool handler modules (158 tools)
